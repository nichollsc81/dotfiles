...
#brew "starship"
## GNU Stow - symlink farm manager (used to deploy these dotfiles)
#brew "stow"
...
#brew "yaml-language-server", link: false
...
## Driftive detects state drifts in Terragrunt projects
#brew "driftive/tap/driftive", trusted: true
...
#brew "knative/client/kn", trusted: true
...
#brew "robscott/tap/kube-capacity", trusted: true
## Terminal-based AI coding assistant
#cask "claude-code@latest"
## Interactive terminal UI for Terraform plan/apply workflows
